...
svgEditor.addExtension("ConnectorMF", function(S) {
...
// 						var sw = line.getAttribute('stroke-width') * 5;
	...
	// Do once
/*mf not sure what this does, but svgCanvas not defined	(function() {
...
// 			updateConnectors();
	...
	return {
		name: "Connector",
		svgicons: "extensionsMF/relations-icon.xml",//"images/conn.svg",
		buttons: [{
			id: "mode_connect",
			type: "mode",
			icon: "images/cut.png",
	...
	/* mf 		includeWith: {
		...
		mouseDown: function(opts) {
			...
			/*this is their code, but we don't need a drag follower
			...
			/*new*/
             ...
             if(available.length===0)
             ...
             else
                 {
                  ...
                  if (reply1!=null&& reply1!="") {  //not cancelled
                       ...
                       if (reply2!=null&& reply2!="") {    //not cancelled at second stage
                    	   while (((reply3.length!==1)|| //not choose 1, choose several
                            ...
                            if (reply3!=null&& reply3!="") {  //not cancelled 
                                ...
                                var relation= relationsMF.makeRelation(reply1,200,200);
     ...
     //            }
			...
			var polyline='<polyline se:connector="svg_a svg_b" fill="none" stroke-width="5" stroke="#000000" points="105 204 190.5 182.299 274 182" id="svg_5"/>';
